...
const Budgets = () => {
  ...
  const generatePDF = async (budget) => {
    ...
    // Rodapé com Marca D'água (Viral Loop)
    doc.setFontSize(8)
    doc.setTextColor(150, 150, 150)
    doc.text('Gerado via ProjectGrid.com.br - Versão Gratuita', 105, 285, { align: 'center' })
          ...
          <div className="bg-amber-50 border border-amber-100 p-4 rounded flex items-center justify-between gap-4 cursor-pointer hover:bg-amber-100 transition-colors" onClick={() => setIsUpgradeModalOpen(true)}>
             <div className="flex items-center gap-4">
                ...
                <p className="text-[10px] text-amber-700 font-bold uppercase tracking-tight">
                  Plano Básico: Limite de {BUDGET_LIMIT} orçamentos atingido. Clique para liberar acesso ilimitado.
                </p>
             </div>
